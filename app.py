...
# ============================================================
# SOC EJECUTIVO — esta ruta necesitaba vivir AQUÍ (después de crear
# `app` y de definir `login_required`), no arriba junto a los imports.
# Antes rompía el arranque completo de la app con:
